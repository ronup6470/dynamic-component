...
import { CustomerList, Customer } from './customer.model';
...
export class CustomerService {
  ...
  private customer: BehaviorSubject<CustomerList>;
  ...
  constructor(
    ...
    this.customer = new BehaviorSubject<CustomerList>(null);
  ...
  public getCustomerList(tableProperty: TableProperty): Observable<CustomerList[]> {
    ...
    const params: any = this.paramProcess(tableProperty);
  ...
  public deleteCustomer(customer: CustomerList): Observable<CustomerList> {
    const url: string = this.baseUrl + 'Customer/' + customer.id;
    let options: any = {
