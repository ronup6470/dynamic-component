/**
 * @author Hem Chudgar.
 * @description Presenter service for card view presentation component.
 */
...
//---------------------------------------------------------------------//
import { requiredFileType, validateFileSize } from 'common-libs';
import { Customer } from '../../customer.model';

/** Presenter */
@Injectable()
export class CustomerCardFormPresenter {
    ...
    public buildForm(): FormGroup {
        return this.fb.group({
            ...
            email: ['', [Validators.pattern('^([0-9a-zA-Z]([-\.\w]*[0-9a-zA-Z])*@([0-9a-zA-Z][-\w]*[0-9a-zA-Z]\.)+[a-zA-Z]{2,9})$')]],
            createdAt: [''],
