...
/** Presenter */
@Injectable()
export class CustomerListCardPresenter {
  ...
  public setTableProp: BehaviorSubject<TableProperty> = new BehaviorSubject(new TableProperty());

  /** This property is used for emit when delete Customer.  */
  private deleteCustomer: Subject<CustomerList> = new Subject();
