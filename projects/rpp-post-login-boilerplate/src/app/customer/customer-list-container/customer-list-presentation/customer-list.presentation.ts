  ...
  public ngAfterViewInit(): void {
    this.breakPointObservableService.deviceObserver$.subscribe((value: BreakPointEnum) => {
      if (value === BreakPointEnum.IsMobile) {
        ...
        this.customerPresenter.viewSizeChange(CustomerListMobilePresentationComponent, this.container);
      } else {
        this.isMobileDevice = false;
        this.customerPresenter.viewSizeChange(CustomerListDesktopPresentationComponent, this.container);
      }
      this.changeDetection.detectChanges();
    });
  }
