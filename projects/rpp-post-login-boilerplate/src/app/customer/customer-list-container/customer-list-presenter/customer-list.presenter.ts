...
import { CustomerListDesktopPresentationComponent } from '../customer-list-presentation/customer-list-desktop-presentation/customer-list-desktop.presentation';
import { CustomerListMobilePresentationComponent } from '../customer-list-presentation/customer-list-mobile-presentation/customer-list-mobile.presentation';
...
export class CustomerListPresenter {
  ...
  private componentRef: ComponentRef<CustomerListDesktopPresentationComponent | CustomerListMobilePresentationComponent>;
   ...
   * @param container 
   */
  public viewSizeChange(
    componentRef: Type<CustomerListMobilePresentationComponent | CustomerListDesktopPresentationComponent>,
    container: ViewContainerRef): void {
    if (this.componentRef) {
      this.componentRef.destroy();
    }
    this.componentRef = container.createComponent<CustomerListMobilePresentationComponent | CustomerListDesktopPresentationComponent>(
